...
from hash_documents import minhash_document,cosine_hash_single_document,shingle_dict,generate_map
from hash_documents import BAND_SIZE,COSINE_BAND_SIZE,NUM_HASHES
import pickle
